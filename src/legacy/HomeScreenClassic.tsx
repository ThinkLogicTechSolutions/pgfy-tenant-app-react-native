/**
 * BACKUP of the original tenant home screen (pre v2 redesign).
 * Kept for reference / rollback — not wired to any route. To restore, copy the
 * body back into `app/(tabs)/index.tsx`.
 *
